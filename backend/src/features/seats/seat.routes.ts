...
router.post('/', authorize(ROLES.OWNER, ROLES.SUPER_ADMIN) as any, validate(createSeatSchema), addSeat as any);
router.post('/bulk-create', authorize(ROLES.OWNER, ROLES.SUPER_ADMIN) as any, validate(bulkCreateSeatsSchema), addSeatsInBulk as any);
